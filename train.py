...
#     # Keep high-frequency words, add PAD/UNK tokens
#     vocab = {'<pad>': 0, '<unk>': 1}
...
# def load_imdb_data(batch_size=64, max_len=500):
...
# def plot_train_curves(cnn_history, lstm_history, n_epochs):
...
# def plot_model_comparison(cnn_metrics, lstm_metrics):
...
#     ax.set_title('CNN vs LSTM Performance Comparison')
#     ax.set_xticks(x)
...
#     # 1. Load data
#     data_config = load_imdb_data(batch_size=BATCH_SIZE, max_len=MAX_LEN)
...
#     # 3. Configure optimizers and loss function
